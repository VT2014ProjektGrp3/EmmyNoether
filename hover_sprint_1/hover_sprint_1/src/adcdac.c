 ...
 *  Author: Tommy
 *	Modified by Alf Stenbrunn & Mattias Nilsson, 2014-01-07
 */ 
...
void adc_setup_audio()
{
	pmc_enable_periph_clk(ID_ADC);
	adc_init(ADC, sysclk_get_main_hz(), 1000000, 0);		//Configure for maximum frequency @ 84 MHz, CHECK THIS!!
...
void adc_setup_buttons()
{
	adc_enable_channel(ADC, ADC_CHANNEL_7);	//PA16 - AD0 for Arduino
}
